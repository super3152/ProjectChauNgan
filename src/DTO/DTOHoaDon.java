...
public class DTOHoaDon {
    ...
    public DTOHoaDon(String SoHoaDon, String NgayTaoHoaDon, int MaNV, int TinhTrang, double TongTien, int MaKhachHang, int TraHang, double CongNo, String HanTraCongNo) {
        this.SoHoaDon = SoHoaDon;
        this.NgayTaoHoaDon = NgayTaoHoaDon;
        this.MaNV = MaNV;
        this.TinhTrang = TinhTrang;
