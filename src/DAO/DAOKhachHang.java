...
public class DAOKhachHang {
 ...
 public static ResultSet LayKhachHangLoc(String GioiTinh,String CongNo, int Trang) {

        String query = "SELECT * FROM `khachhang` WHERE gioitinh like '%"+GioiTinh+"%' and congno "+CongNo+" limit "+Trang+",13";
        ResultSet rs = DBConection.GetData(query);
