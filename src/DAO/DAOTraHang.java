...
public class DAOTraHang {
    public static ResultSet LaySoHoaDon(int MaHD){
     ...
     public static ResultSet LayTraHangLoc(String MaKhachHang, String MaNhanVien, String TrangThai, String HoanTien, int Trang){
        String query = "Select * from trahang where idkhachhang like '%"+MaKhachHang+"%' and idnguoidung like '%"+MaNhanVien+"%' and trangthai like '%"+TrangThai+"%' and hoantien like '%"+HoanTien+"%' limit "+Trang+", 13";
        ResultSet rs = DAO.DBConection.GetData(query);
    ...
    public static ResultSet LayTraHang(String TuKhoa,int trang){
        String query = "Select * from trahang where sotrahang like '%"+TuKhoa+"%' or tongtien like '%"+TuKhoa+"%' limit "+trang+", 13";
        ResultSet rs = DAO.DBConection.GetData(query);
        return rs;
    }
