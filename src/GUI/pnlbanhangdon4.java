 ...
 */
public class pnlbanhangdon4 extends javax.swing.JPanel {
    ...
    public pnlbanhangdon4() {
        ...
        if (SoHoaDon == null) {
            ...
            BLL.BLLHoaDon.DoSanPhamLenLaiHoaDon4(tblChiTietHoaDon, MaHD);
    ...
    pnlbanhangdon4(int MaHD, String SoHoaDon) {
        pnlbanhangdon4.MaHD = MaHD;
        pnlbanhangdon4.SoHoaDon = SoHoaDon;
    }
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
                        ...
                        if (MaSP == MaSPB) {
                            ...
                            model.removeRow(i);
                            double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDonTrungdon4(tblChiTietHoaDon, sp, SoLuong, UuDai);
                    ...
                    double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDondon4(tblChiTietHoaDon, sp, SoLuong, UuDai);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("THÔNG TIN ĐƠN HÀNG 4");
    ...
    private void btnChonSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonSPActionPerformed
        ...
        int column = 0;
        int row = pnlbanhangdon4.jTable1.getSelectedRow();
        String value = pnlbanhangdon4.jTable1.getModel().getValueAt(row, column).toString();
    ...
    private void cbbKhachHangItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbbKhachHangItemStateChanged
        if (tblChiTietHoaDon.getRowCount() != 0) {
            ...
            for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
                ...
                double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDonTheoLoaiKHdon4(tblChiTietHoaDon, sp, SoLuong, UuDai);
                DefaultTableModel model = (DefaultTableModel) tblChiTietHoaDon.getModel();
                model.removeRow(i);
                double TongTienCu = ChuyenDoi.ChuyenSangSo(txtTongTien.getText());
                double TongTienTru = TongTienCu - TongTien;
