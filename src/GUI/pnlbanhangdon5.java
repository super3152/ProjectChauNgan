 ...
 */
public class pnlbanhangdon5 extends javax.swing.JPanel {
    ...
    public pnlbanhangdon5() {
        ...
        if (SoHoaDon == null) {
            ...
            BLL.BLLHoaDon.DoSanPhamLenLaiHoaDon5(tblChiTietHoaDon, MaHD);
    ...
    pnlbanhangdon5(int MaHD, String SoHoaDon) {
        pnlbanhangdon5.MaHD = MaHD;
        pnlbanhangdon5.SoHoaDon = SoHoaDon;
    }
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
                        ...
                        if (MaSP == MaSPB) {
                            ...
                            model.removeRow(i);
                            double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDonTrungdon5(tblChiTietHoaDon, sp, SoLuong, UuDai);
                    ...
                    double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDondon5(tblChiTietHoaDon, sp, SoLuong, UuDai);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("THÔNG TIN ĐƠN HÀNG 5");
    ...
    private void btnChonSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonSPActionPerformed
        ...
        int column = 0;
        int row = pnlbanhangdon5.jTable1.getSelectedRow();
        String value = pnlbanhangdon5.jTable1.getModel().getValueAt(row, column).toString();
    ...
    private void cbbKhachHangItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbbKhachHangItemStateChanged
        if (tblChiTietHoaDon.getRowCount() != 0) {
            ...
            for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
                ...
                double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDonTheoLoaiKHdon5(tblChiTietHoaDon, sp, SoLuong, UuDai);
                DefaultTableModel model = (DefaultTableModel) tblChiTietHoaDon.getModel();
                model.removeRow(i);
                double TongTienCu = ChuyenDoi.ChuyenSangSo(txtTongTien.getText());
                double TongTienTru = TongTienCu - TongTien;
