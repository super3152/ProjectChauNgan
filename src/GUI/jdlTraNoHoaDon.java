...
public class jdlTraNoHoaDon extends javax.swing.JDialog {
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        String HangMucThuChi = "Nhận Nợ";
    
        double TongTienThu = BLL.ChuyenDoi.ChuyenTien(txtThanhToan.getText());

        String GhiChu = "Thu Nợ Khách Hàng " + kh.getTenKhachHang() + "";
        DTOPhieuThuChi ptc = new DTOPhieuThuChi(MaThuChi, IDKhachHang, LoaiPhieu, HangMucThuChi, TongTienThu, GhiChu);
