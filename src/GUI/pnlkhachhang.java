...
import static GUI.jdlLocKhachHang.CongNo;
import static GUI.jdlLocKhachHang.GioiTinh;
...
public final class pnlkhachhang extends javax.swing.JPanel {
    ...
    public static String LocKhachHang;
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(lblCountPagekh, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnFirstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFirstActionPerformed
        if (LocKhachHang.equals("Đang Lọc")) {
            trangKhachHang = 0;
            BLL.BLLKhachHang.HienThiKhachHangLoc(tblkhachhang, GioiTinh, CongNo, trangKhachHang);
            trangKhachHang1 = 1;
            btnNext.setEnabled(true);
            btnLast.setEnabled(true);
            btnFirst.setEnabled(false);
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        if (LocKhachHang.equals("Đang Lọc")) {
            if (trangKhachHang1 == 2) {
                ...
                BLL.BLLKhachHang.HienThiKhachHangLoc(tblkhachhang, GioiTinh, CongNo, trangKhachHang);
                lblNumberPageKH.setText("" + (trangKhachHang1 = (trangKhachHang1 - 1)));
                lblCountPagekh.setText("" + trangKhachHang1 + "/" + soTrangKhachHang);
                btnBack.setEnabled(false);
                btnFirst.setEnabled(false);
                btnNext.setEnabled(true);
