...
import static GUI.pnlsanpham.soTrangSP;
...
import static GUI.pnlthongke.trangThuChi1;
 ...
 */
public class pnlbanhang1 extends javax.swing.JPanel {
    ...
    pnlbanhang1(int MaHD, String SoHoaDon) {
        pnlbanhang1.MaHD = MaHD;
        pnlbanhang1.SoHoaDon = SoHoaDon;
    }
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
                        ...
                        if (MaSP == MaSPB) {
                            ...
                            model.removeRow(i);
                            double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDonTrung2(tblChiTietHoaDon, sp, SoLuong, UuDai);
                    ...
                    double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDon2(tblChiTietHoaDon, sp, SoLuong, UuDai);
    ...
    private void initComponents() {
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtTimSP, javax.swing.GroupLayout.DEFAULT_SIZE, 227, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnChonSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonSPActionPerformed
        ...
        int column = 0;
        int row = pnlbanhang1.jTable1.getSelectedRow();
        String value = pnlbanhang1.jTable1.getModel().getValueAt(row, column).toString();
    ...
    private void cbbKhachHangItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbbKhachHangItemStateChanged
        if (tblChiTietHoaDon.getRowCount() != 0) {
            ...
            for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
                ...
                double tongTien = BLL.BLLHoaDon.NhapSanPhamVaoChiTietHoaDonTheoLoaiKH2(tblChiTietHoaDon, sp, SoLuong, UuDai);
                DefaultTableModel model = (DefaultTableModel) tblChiTietHoaDon.getModel();
                model.removeRow(i);
                double TongTienCu = ChuyenDoi.ChuyenSangSo(txtTongTien.getText());
                double TongTienTru = TongTienCu - TongTien;
