...
public class BLLDonHang {
     public static void HienThiDonHang(JTable tbl, String TuKhoa,int trang) {
            ...
            while (rs.next()) {
               ...
               if (rs.getInt("trangthaihoadon") == 1) {
                 ...
                 if (rs.getInt("tinhtrang") == 0) {
                    ...
                    obj[7] = "<html><body style='color:red;'>Đã thanh toán</body></html>";
                }
                ...
                if (rs.getInt("view") == 0) {
                    ...
                    obj[9] = "<html><body style='color:red;'>Đã Xem</body></html>";
                }
                tbModel.addRow(obj);
            }
       ...
       public static void HienThiHoaDonKhachHang(JTable tbl) {
        ResultSet rs = DAO.DAODonHang.LayChiHoaDonKhachHang();
        DefaultTableModel tbModel = (DefaultTableModel) tbl.getModel();
        tbModel.setRowCount(0);
        ...
        try {
            while (rs.next()) {
                ...
                obj[0] =("Bạn có đơn hàng mới vào lúc - "+ rs.getTimestamp(1));
                tbModel.addRow(obj);
            }
        } catch (SQLException ex) {
      ...
      public static void HienThiDonHangDongGoi(JTable tbl, String TuKhoa,int trang) {
        ResultSet rs = DAO.DAODonHang.LayDonHangDongGoi(TuKhoa,trang);
        DefaultTableModel tbModel = (DefaultTableModel) tbl.getModel();
        tbModel.setRowCount(0);
        Object obj[] = new Object[10];
        try {
            while (rs.next()) {
               ...
               if (rs.getInt("trangthaihoadon") == 2) {
                     obj[6] = "<html><body style='color:red;'>Đóng gói</body></html>";
                }
                 if (rs.getInt("tinhtrang") == 0) {
                     obj[7] = "<html><body style='color:red;'>Chưa thanh toán</body></html>";
                } else {
                ...
                obj[8] = rs.getDouble("tongtien");
                if (rs.getInt("hinhthucthanhtoan") == 0) {
                    obj[9] = "<html><body style='color:blue;'>Ship COD</body></html>";
                }else{
                    obj[9] = "<html><body style='color:blue;'>Nhận tại cửa hàng</body></html>";
                }
       ...
       public static void HienThiDonHangGiaoHang(JTable tbl, String TuKhoa,int trang) {
        ResultSet rs = DAO.DAODonHang.LayDonHangGiaoHang(TuKhoa,trang);
        DefaultTableModel tbModel = (DefaultTableModel) tbl.getModel();
        tbModel.setRowCount(0);
        Object obj[] = new Object[10];
        try {
            while (rs.next()) {
               ...
               if (rs.getInt("trangthaihoadon") == 3) {
                     obj[6] = "<html><body style='color:red;'>Giao hàng</body></html>";
                }
                 if (rs.getInt("tinhtrang") == 0) {
                     obj[7] = "<html><body style='color:red;'>Chưa thanh toán</body></html>";
                } else {
        ...
        public static void HienThiDonHangHoanThanh(JTable tbl, String TuKhoa,int trang) {
        ResultSet rs = DAO.DAODonHang.LayDonHangHoanThanh(TuKhoa,trang);
        DefaultTableModel tbModel = (DefaultTableModel) tbl.getModel();
        tbModel.setRowCount(0);
        Object obj[] = new Object[10];
        try {
            while (rs.next()) {
               ...
               if (rs.getInt("trangthaihoadon") == 4) {
                     obj[6] = "<html><body style='color:red;'>Hoàn thành</body></html>";
                }
                 if (rs.getInt("tinhtrang") == 0) {
                     obj[7] = "<html><body style='color:red;'>Chưa thanh toán</body></html>";
                } else {
         ...
         public static void HienThiDonHangHuy(JTable tbl, String TuKhoa,int trang) {
        ResultSet rs = DAO.DAODonHang.LayDonHangHuy(TuKhoa,trang);
        DefaultTableModel tbModel = (DefaultTableModel) tbl.getModel();
        tbModel.setRowCount(0);
        Object obj[] = new Object[10];
        try {
            while (rs.next()) {
               ...
               if (rs.getInt("trangthaihoadon") == 5) {
