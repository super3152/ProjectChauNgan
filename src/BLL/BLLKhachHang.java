...
public static void HienThiKhachHangLoc(JTable tbl,String GioiTinh, String CongNo, int Trang) {
        ResultSet rs = DAO.DAOKhachHang.LayKhachHangLoc(GioiTinh, CongNo, Trang);
        DefaultTableModel tbModel = (DefaultTableModel) tbl.getModel();
        tbModel.setRowCount(0);
